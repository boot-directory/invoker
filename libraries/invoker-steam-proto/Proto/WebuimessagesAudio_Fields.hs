...
module Proto.WebuimessagesAudio_Fields where
...
channelNum ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "channelNum" a) =>
  Lens.Family2.LensLike' f s a
channelNum = Data.ProtoLens.Field.field @"channelNum"
maybe'channelNum ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'channelNum" a) =>
  Lens.Family2.LensLike' f s a
maybe'channelNum = Data.ProtoLens.Field.field @"maybe'channelNum"
maybe'success ::
  forall f s a.
  (Prelude.Functor f,
