...
module Proto.WebuimessagesUser_Fields where
...
maybe'savedHardwareId ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'savedHardwareId" a) =>
  Lens.Family2.LensLike' f s a
maybe'savedHardwareId
...
savedHardwareId ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "savedHardwareId" a) =>
  Lens.Family2.LensLike' f s a
savedHardwareId = Data.ProtoLens.Field.field @"savedHardwareId"
systemInfo ::
  forall f s a.
  (Prelude.Functor f,
