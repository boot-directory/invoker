...
module Proto.WebuimessagesSleep_Fields where
...
currentState ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "currentState" a) =>
  Lens.Family2.LensLike' f s a
currentState = Data.ProtoLens.Field.field @"currentState"
isLowPowerDownloadSupported ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "isLowPowerDownloadSupported" a) =>
  Lens.Family2.LensLike' f s a
isLowPowerDownloadSupported
  = Data.ProtoLens.Field.field @"isLowPowerDownloadSupported"
maybe'currentState ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'currentState" a) =>
  Lens.Family2.LensLike' f s a
maybe'currentState
...
maybe'isLowPowerDownloadSupported ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'isLowPowerDownloadSupported" a) =>
  Lens.Family2.LensLike' f s a
maybe'isLowPowerDownloadSupported
...
maybe'optionallyTransitionToLowPowerDownloads ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'optionallyTransitionToLowPowerDownloads" a) =>
  Lens.Family2.LensLike' f s a
maybe'optionallyTransitionToLowPowerDownloads
...
optionallyTransitionToLowPowerDownloads ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "optionallyTransitionToLowPowerDownloads" a) =>
  Lens.Family2.LensLike' f s a
optionallyTransitionToLowPowerDownloads
  = Data.ProtoLens.Field.field
      @"optionallyTransitionToLowPowerDownloads"
